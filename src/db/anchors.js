...
const { anchorActionRow } = require('./anchors/anchor_action_row.js');
...
module.exports = {
    ...
    async createAnchorAction(data){
        ...
        // Every bound value is coerced to fit its column first (anchor_action_row.js says why
        // a rejected wire must still store): args follows the column order of the UPDATE SET
        // and the INSERT below, and section_index is the second half of the row key.
        let { section_index, args } = anchorActionRow(data, status_id);
