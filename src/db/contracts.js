...
const stakes             = require('./contracts/stakes.js');
const delegationRotation = require('./contracts/delegation_rotation.js');
const stakeSnapshot      = require('./contracts/vm_stake_snapshot.js');
const slash              = require('./contracts/slash.js');
const cooldowns          = require('./contracts/cooldowns.js');
