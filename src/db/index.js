...
// migrations, the transaction plumbing and the statics. The set is a list rather than
// a directory scan so a file dropped into db/ cannot silently add prototype methods.
const MIXIN_FILES = [
    './actions.js',
    './addresses.js',
    './airdrops.js',
...
for(const file of MIXIN_FILES){
    const descriptors = Object.getOwnPropertyDescriptors(require(file));
