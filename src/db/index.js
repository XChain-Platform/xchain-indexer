...
const { requireStakeWeight, normalizeStakeAmount, AUTO_DEDUP_TABLES, recordShapeDrift, txEpochStore, CANONICAL_CARET_ID, usesCapabilitySnapshot, opensBackslashEscape } = require('./shared.js');
