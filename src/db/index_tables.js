...
const addresses    = require('./index_tables/addresses.js');
const tickers      = require('./index_tables/tickers.js');
const expiredItems = require('./index_tables/expired_items.js');
