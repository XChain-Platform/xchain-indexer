...
-- test/unit/migration/migration_preconditions.test.js refuses the combination auto + tagged.
--
...
-- migrated database and a fresh install (test/unit/migration/sql_schema_column_parity.test.js
