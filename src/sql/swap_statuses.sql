...
CREATE TABLE swap_statuses (
    ...
    status_id         BIGINT UNSIGNED           -- id of record in index_statuses table (status of swap tx open/complete/cancelled/expired)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

CREATE UNIQUE INDEX action_index      ON swap_statuses (action_index);
