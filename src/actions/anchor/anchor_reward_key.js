 ...
 * archive replay guard in actions/anchor/index.js reasons about). After a rebase the hub reissues
 ...
 * never drift: the DOGE-side parse writer (actions/anchor/index.js), the BTC-side derive writer
