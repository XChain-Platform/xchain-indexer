...
module.exports = {
    ...
    getConfig: function(network){
        ...
        config['FEE_PAYMENT_MODE'] = 'native';               // LTC: 'native' only (no XCHAIN balance deduction). Informational only; not read at runtime. See CONFIGURATION.md and detectFeePaymentMode() in utility.js.
        ...
        config['STAKING'] = {
            COOLDOWN_BLOCKS:         4032,                     // ~7 days at ~2.5 min/block before unstaked XCHAIN is returned
