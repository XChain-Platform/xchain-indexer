...
async function prepareExplorerQueryData() {
...
function registerExplorerQueryGroup1() {
describe('pagination and filtering', function () {

        beforeEach(async function () {
            await prepareExplorerQueryData();
        });
        ...
        // ---------------------------------------------------------------
        registerExplorerQueryCase1()

        // ---------------------------------------------------------------
        // By block: mints for a specific block
        // ---------------------------------------------------------------
        registerExplorerQueryCase2()

        // ---------------------------------------------------------------
        // By token: all mints for PTOK
        // ---------------------------------------------------------------
        registerExplorerQueryCase3()

        // ---------------------------------------------------------------
        // Pagination: limit parameter
        // ---------------------------------------------------------------
        registerExplorerQueryCase4()

        // ---------------------------------------------------------------
        // Pagination: page 2 returns different data than page 1
        // ---------------------------------------------------------------
        registerExplorerQueryCase5()

        // ---------------------------------------------------------------
        // Sends by source vs destination
        // ---------------------------------------------------------------
        registerExplorerQueryCase6()

        registerExplorerQueryCase7()

        // ---------------------------------------------------------------
        // Sends by token
        // ---------------------------------------------------------------
        registerExplorerQueryCase8()
    });
}

function registerExplorerQueryGroup2() {
describe('pagination and filtering', function () {
        ...
        // Holders endpoint
        // ---------------------------------------------------------------
        registerExplorerQueryCase9()

        // ---------------------------------------------------------------
        // Balances includes tick metadata
        // ---------------------------------------------------------------
        registerExplorerQueryCase10()

        // ---------------------------------------------------------------
        // Block endpoint
        // ---------------------------------------------------------------
        registerExplorerQueryCase11()

        // ---------------------------------------------------------------
        // Status endpoint
        // ---------------------------------------------------------------
        registerExplorerQueryCase12()

        // ---------------------------------------------------------------
        // Tokens list by address
        // ---------------------------------------------------------------
        registerExplorerQueryCase13()

        // ---------------------------------------------------------------
        // Credits by block
        // ---------------------------------------------------------------
        registerExplorerQueryCase14()

        // ---------------------------------------------------------------
        // Explorer endpoint (DataTables format)
        // ---------------------------------------------------------------
        registerExplorerQueryCase15()

        // ---------------------------------------------------------------
        // History by token
        // ---------------------------------------------------------------
        registerExplorerQueryCase16()
    });
}

function registerExplorerQueryCase1() {
...
function registerExplorerQueryCase2() {
...
function registerExplorerQueryCase3() {
...
function registerExplorerQueryCase4() {
...
function registerExplorerQueryCase5() {
...
function registerExplorerQueryCase6() {
...
function registerExplorerQueryCase7() {
...
function registerExplorerQueryCase8() {
...
function registerExplorerQueryCase9() {
...
function registerExplorerQueryCase10() {
...
function registerExplorerQueryCase11() {
...
function registerExplorerQueryCase12() {
...
function registerExplorerQueryCase13() {
...
function registerExplorerQueryCase14() {
...
function registerExplorerQueryCase15() {
...
function registerExplorerQueryCase16() {
...
registerExplorerQueryGroup1()
    registerExplorerQueryGroup2()
});
