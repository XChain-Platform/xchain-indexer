 ...
 *
 * Its unit sibling (test/unit/anchor/db_get_archive_replay_watermarks.test.js) stubs
...
const DB_NAME = process.env.TEST_ARCHIVE_WATERMARKS_DB || 'xchain_archive_watermarks';
