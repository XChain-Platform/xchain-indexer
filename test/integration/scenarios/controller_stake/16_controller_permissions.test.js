 ...
 * pinned by test/unit/db/ledger/contract_permissions_persist.test.js).
 *
 ...
 *   npx mocha --no-config --exit test/integration/scenarios/controller_stake/16_controller_permissions.test.js
 ********************************************************************/
'use strict';
