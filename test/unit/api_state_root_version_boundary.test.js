 ...
 * and compiles the response literal, the same way api_pushgeneration_stamping.test.js
 * and api_auth_batch.test.js do, so the assertion executes the real shipped
