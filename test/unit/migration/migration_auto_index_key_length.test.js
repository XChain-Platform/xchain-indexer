 ...
 * an applied migration changes its sha256 and fails `node src/db/migration/migrate.js` closed forever
 ...
 * construction: sql_schema_index_parity.test.js already forbids an index that exists only
