...
// Unit coverage for src/hub/hub_schema_version.js: the hub-mirror schema-version
...
const mod = require('../../../src/hub/hub_schema_version.js');
...
describe('hub-schema-version', function () {
    ...
    it('is a stable primitive across re-require (frozen constant, no lazy init)', function () {
        ...
        delete require.cache[require.resolve('../../../src/hub/hub_schema_version.js')];
        const again = require('../../../src/hub/hub_schema_version.js');
