 ...
 *
 **********************************************************************
 * test/unit/price/xchain_price.test.js
 *
...
const { deriveXchainRate, referenceRateFromUsd, toUsd } = require('../../../src/consensus/xchain_price.js');
...
describe('XCHAIN price derivation from realized fills @regression', () => {
    let util;
...
describe('XCHAIN price derivation from realized fills @regression', () => {
    ...
    describe('manipulation resistance (spec §5)', () => {
