 ...
 *
 **********************************************************************
 * test/unit/rollcall/db_rollcalls_public_reads.test.js
 *
 ...
 *
 * Mock-based (doQuery stubbed), matching db_swq_source_cap.test.js: the SQL
 * shape and bound args are asserted directly against the captured query, the
 * same convention api_federation_read_isolation.test.js uses at the api.js
