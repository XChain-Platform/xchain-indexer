 ...
 * isolation.test.js / api_state_root_version_boundary.test.js technique: read the
...
describe('db.getPendingBridgeTransfers @regression @tier1', function(){
    ...
    // db_pending_bridge_transfers.test.js; this stub test pins the statement shape the
