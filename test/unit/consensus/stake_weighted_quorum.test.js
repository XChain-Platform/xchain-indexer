 ...
 *
 **********************************************************************
 * test/unit/consensus/stake_weighted_quorum.test.js
 *
 ...
 * by consensus_primitive_conformance.test.js. This suite adds behavioral property
...
function registerStakeThresholdTestsOne() {
...
function registerStakeThresholdTestsTwo() {
    describe('meetsStakeThreshold', function () {
...
function registerStakeActivationTests() {
...
function registerStakeActivationParityTest() {
    ...
    // the real "N independent implementations agree on the same locked snapshot"
    // check the activation-map assert above cannot give. Fixtures are generated by
    // a SEEDED PRNG so any failure reproduces exactly.
function registerSybilResistanceTest() {
...
function registerCrossEngineDeterminismTest() {
...
function registerDelegationTotalStakeTest() {
...
function registerDelegationInflationTest() {
    describe('delegation source-dedup invariant (§3.7, R-2)', function () {
        function rng(seed) {
            return function () {
                seed |= 0; seed = (seed + 0x6D2B79F5) | 0;
...
describe('stake_weighted_quorum (indexer)', function () {
    registerStakeThresholdTestsOne();
    registerStakeThresholdTestsTwo();
    registerStakeActivationTests();
    registerStakeActivationParityTest();
    registerSybilResistanceTest();
    registerCrossEngineDeterminismTest();
    registerDelegationTotalStakeTest();
    registerDelegationInflationTest();
});
