 ...
 *
 **********************************************************************
 * test/unit/db/db_get_block_hashes_tieorder.test.js
 *
 ...
 * The tests below pin that order.
 *
 * Technique mirrors db_queries.test.js: stub doQuery on a prototype-borrowed Database so the
