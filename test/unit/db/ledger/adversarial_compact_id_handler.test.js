...
/*********************************************************************
 * test/unit/db/ledger/adversarial_compact_id_handler.test.js
 *
...
async function runMint({ destination }) {
    ...
    const indexerDb = {
        ...
        // Flag-day-gated companion the handler actually calls. `rejected` is the
