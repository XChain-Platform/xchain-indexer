 ...
 *
 **********************************************************************
 * test/unit/db/markets/batched_coinpay_multi_payee.test.js
 *
 ...
 * batch_settlement_value_ledger.test.js).
 *
...
describe('batched COINPAY resolves its own payment output @regression @tier1', function () {
    describe('ledger shape', function () {
        ...
        // and the full case lives in fee_probe_batched_coinpay_parity.test.js.
