...
// unit), the network, or the coin. The rows whose predicate W4 (25) and W5
// (13 predicate-only twins, row 21) replaced with activeAt() itself are not
// here: there is no second implementation left to compare, and the suite lists
