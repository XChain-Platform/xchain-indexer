...
// The FILE handler's gated-content and strict GATE_MIN_AMOUNT rules. The plain
// record fields and the COMPRESSION field are the parts in file.test/, over the
// shared fixture in file.test/helpers/fixture.js.
...
const { buildFile } = require('./file.test/helpers/fixture.js');
...
/** The gated-content stubs every gated test starts from. */
function stubGatedToken() {
